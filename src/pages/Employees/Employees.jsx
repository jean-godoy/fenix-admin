                                ...
                                {data.length && data.map(item => {
                                    return (
                                        <li key={item.id_user} className="box-list-li">
                                            <Link className="box-list-link" to={`/employee-details/${item.id_employee}`} >
                                                <span className="box-list-span"><b>Nome: </b>{item.employee_name} </span>
                                                <span className="box-list-span"><b>E-mail: </b>{item.email} </span>
                                            </Link>
                                        </li>
                                    )
                                })}
